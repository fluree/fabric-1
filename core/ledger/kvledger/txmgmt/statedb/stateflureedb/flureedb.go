...
//flureeInstance represents a FlureeDB instance
type flureeInstance struct {
	conf   *ledger.FlureeDBConfig
	client *http.Client // a client to connect to this instance
	// stats  *stats
}

//flureeDatabase represents a database within a FlureeDB instance
type flureeDatabase struct {
	flureeInstance *flureeInstance //connection configuration
	dbName         string
	// indexWarmCounter int
}

//dbReturn contains an error reported by FlureeDB
...
func (dbclient *flureeDatabase) createDatabaseIfNotExist() error {
